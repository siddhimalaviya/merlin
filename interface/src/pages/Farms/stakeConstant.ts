...
export const FIAT_FIXED_PERCENTAGE = 2;
export const BRAND_NAME = 'VIROTHIUM';
...
async function getAPYValue(priceInUsdOfToken0: any, totalLiquidityValue: any) {
    try {
...
export async function stakeToken(account: any, stakeAmountInEther: any) {
    try {
...
export async function unStakeToken(account: any, UnstakeAmountInEther: any) {
    try {
...
export async function harvestToken(account: any) {
    try {
        console.log("started Unstaking amount...");
        const contract = await stakecontractInstance()
